...
def potencia_manual(base, potencia):
    ...
    # El ciclo for de la variable "i" se ejecuta las veces que pida el parámetro
    # "potencia", mientras que el ciclo for de la variable "j" va a efectuarse
    # según el valor del parámetro "base".

    # La lógica de estos ciclos for consiste en sumar "base" veces el valor de base,
    # guardando el valor en la variable suma, para luego actualizar "base" y repetir.
    # Ejemplo: 
    # 7**3: base = 7, suma = 7+7+7+7+7+7+7 = 49.
    # base = suma = 49.
    # base = 49, suma = 49+49+49+49+49+49+49 = 343, que es el resultado buscado. 
